...
import com.fjern.test.common.client.security.TokenResponse;
...
public class OAuthAuthenticator implements ITestAuthenticator {
    ...
    final String getAccessToken(String username, String password) {
        try {
            ...
            final com.fjern.test.common.client.security.TokenResponse tokenResponse = restTemplate.postForObject(url, request, TokenResponse.class);
